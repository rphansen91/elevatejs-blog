...
export default () => (
  <div style={{ textAlign: "left", padding: "1em" }}>
    ...
    <section>
      <Typography paragraph variant="subheading" color="textPrimary">
        OVERVIEW
      </Typography>
      <Typography paragraph variant="body1" color="textSecondary">
        This website is operated by Hodl Stream. Throughout the site, the terms
        “we”, “us” and “our” refer to Hodl Stream. Hodl Stream offers this
    ...
    <section>
      ...
      <Typography paragraph variant="body1" color="textSecondary">
        In no case shall Hodl Stream, our directors, officers, employees,
      ...
      <Typography paragraph variant="body1" color="textSecondary">
        You agree to indemnify, defend and hold harmless Hodl Stream and our
      ...
      <Typography paragraph variant="body1" color="textSecondary">
        ...
        laws of 101 W Broadway St 1120, San Diego, CA, 92001, United States.
      </Typography>
